            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <div id="subPages1" class="collapse ">
                        <ul class="nav">
                            <li><a href="/pemesanan" class="lnr lnr-book">Pemesanan</a></li>
                            <li><a href="/supplier" class="lnr lnr-book">Pembayaran</a></li>
                            <li><a href="/penerimaan" class="lnr lnr-book">Penerimaan</a></li>
